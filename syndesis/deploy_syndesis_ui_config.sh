...
oc get configmap syndesis-ui-config -o jsonpath={.data."config\.json"} \
  | jq '.branding += { "logoWhiteBg": "", "logoDarkBg": "", "iconWhiteBg": "assets/images/FuseOnlineLogo_Black.svg", "iconDarkBg": "assets/images/FuseOnlineLogo_White.svg", "appName": "Ignite", "productBuild": true }' > /tmp/config.json
