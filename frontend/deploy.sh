...
then
    ...
    GESTURE_PARAMS='-p REPLICAS=1 -p CONTAINER_REQUEST_CPU=100m -p CONTAINER_REQUEST_MEMORY=100Mi -p'
    GAME_SERVER_PARAMS='-p REPLICAS=1 -p CONTAINER_REQUEST_CPU=100m -p CONTAINER_REQUEST_MEMORY=100Mi'
    GAME_UI_PARAMS='-p REPLICAS=1 -p CONTAINER_REQUEST_CPU=50m -p CONTAINER_REQUEST_MEMORY=100Mi'
    ADMIN_SERVER_PARAMS="-p REPLICAS=1 -p CONTAINER_REQUEST_CPU=100m -p CONTAINER_REQUEST_MEMORY=100Mi -p PASSWORD=${ADMIN_PASSWORD}"
    ADMIN_UI_PARAMS='-p REPLICAS=1 -p CONTAINER_REQUEST_CPU=50m -p CONTAINER_REQUEST_MEMORY=100Mi'
    DASHBOARD_SERVER_PARAMS='-p REPLICAS=1 -p CONTAINER_REQUEST_CPU=100m -p CONTAINER_REQUEST_MEMORY=100Mi'
    DASHBOARD_UI_PARAMS='-p REPLICAS=1 -p CONTAINER_REQUEST_CPU=50m -p CONTAINER_REQUEST_MEMORY=100Mi'
    LEADERBOARD_BACKGROUND_PARAMS='-p CONTAINER_REQUEST_CPU=100m -p CONTAINER_REQUEST_MEMORY=100Mi'
    LEADERBOARD_SERVER_PARAMS='-p REPLICAS=1 -p CONTAINER_REQUEST_CPU=100m -p CONTAINER_REQUEST_MEMORY=100Mi'
    LEADERBOARD_UI_PARAMS='-p REPLICAS=1 -p CONTAINER_REQUEST_CPU=50m -p CONTAINER_REQUEST_MEMORY=100Mi'
else
    ...
    ADMIN_SERVER_PARAMS="-p REPLICAS=2 -p PASSWORD=${ADMIN_PASSWORD}"
